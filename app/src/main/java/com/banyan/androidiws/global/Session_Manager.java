...
public class Session_Manager {
    ...
    public static final String KEY_USER_PROFILE_ID ="str_user_profile_id";
    ...
    public void createLoginSession(String user_id, String user_name, String type_id, String user_role, String user_department_id, String profile_id ) {
        ...
        editor.putString(KEY_USER_PROFILE_ID, profile_id);
